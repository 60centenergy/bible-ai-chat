...
// Simple Groq proxy endpoint (no auth required)
app.post('/api/groq', async (req: any, res: Response) => {
  try {
    console.log('📤 Groq proxy request received');
    ...
    console.log(`✅ Groq response received (${response.length} chars)`);
